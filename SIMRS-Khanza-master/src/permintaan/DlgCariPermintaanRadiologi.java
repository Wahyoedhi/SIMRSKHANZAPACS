...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnLihatGambarJiiAll1 = new widget.Button();
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-05-2023 08:08:31" }));
        ...
        BtnLihatGambarJiiAll1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnLihatGambarJiiAll1.setText("Lihat Gambar ke RIS JI'I All");
        BtnLihatGambarJiiAll1.setFocusPainted(false);
        BtnLihatGambarJiiAll1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnLihatGambarJiiAll1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLihatGambarJiiAll1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLihatGambarJiiAll1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLihatGambarJiiAll1.setName("BtnLihatGambarJiiAll1"); // NOI18N
        BtnLihatGambarJiiAll1.setPreferredSize(new java.awt.Dimension(215, 23));
        BtnLihatGambarJiiAll1.setRoundRect(false);
        BtnLihatGambarJiiAll1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLihatGambarJiiAll1ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnLihatGambarJiiAll1);
...
private void tbRadiologiRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRadiologiRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnLihatGambarJiiAll1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLihatGambarJiiAll1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnLihatGambarJiiAll1ActionPerformed
    ...
    */
    ...
    private widget.Button BtnLihatGambarJiiAll1;
